...
! function (e) {
    ...
    v.extend(k.prototype, {
        ...
        _buildButton: function (n, t, e, o) {
            ...
            var s, r, a, l, u = this.c.dom.button,
        ...
        _resolveExtends: function (e) {
            ...
            for (e = t(e); e && e.extend;) {
                ...
                if (u) {
                    for (e.buttons || (e.buttons = []), n = 0, o = u.length; n < o; n++) e.buttons.splice(n, 0, u[n]);
        ...
        for (var u = [], c = function (t, n, e) {
            ...
            if (Array.isArray(t) || t instanceof v)
                ...
                for (s = 0, r = e.length; s < r; s++) u.push({
                    inst: n,
                    node: e[s].node
                });
                ...
                if (-1 !== t.indexOf(","))
                    ...
                    for (s = 0, r = e.length; s < r; s++) e[s].name === l && u.push({
                        inst: n,
                        node: e[s].node
                    })
            ...
            else "object" != typeof t || !t.nodeName || -1 !== (a = v.inArray(t, o)) && u.push({
                inst: n,
                node: o[a]
            })
    ...
    var i, n = function (t) {
        ...
        u = function (e, t) {
            for (var o = v.extend(!0, {}, {
                ...
                for (var f = [a], p = 0; p < a; p++) f[p] = o.format.body(s[u], c, p, r[u]), u++;
                l[c] = f
            }
            i = {
                header: t,
