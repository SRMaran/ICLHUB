...
public partial class Web_Confirmedbooking : System.Web.UI.Page
{
    DataAccess da;
    PhTemplate PH;
    Decrypt DE;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Txt_Todate.Attributes.Remove("min");
            Txt_Todate.Attributes.Remove("max");
            Txt_Todate.Text = DateTime.Now.ToString("yyyy-MM-dd");
            //Txt_Todate.Attributes["max"] = DateTime.Now.ToString("yyyy-MM-dd");
