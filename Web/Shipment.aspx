<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Shipment.aspx.cs" Inherits="Web_Shipment" %>
              ...
              <script>
               ...
               <script>   
                   function handleShipmentAction(element, action) {
                       ...
                       $.ajax({
                           type: "POST",
                           url: "Shipment.aspx/InsertShipment",
                    ...
                    <div class="row mb-3">
                        <div class="col d-flex align-items-center">
                            <div class="login-header">
                                <h4>Shipments</h4>
                                <p>Here’s where you keep up with all your shipments.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        function initializeDataTable(Transport, Roledatas, codedatas, Pin) {
            $("#shipmentTable").DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Shipment.aspx/GetShipmentDetails",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify({
                            start: data.start,
        ...
        function initializeDataTablefilter(Transport, Startdate, Enddate, Roledatas, codedatas) {
            $("#shipmentTable").DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Shipment.aspx/GetShipmentDetailsfilter",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify({
                            start: data.start,
