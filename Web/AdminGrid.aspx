<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AdminGrid.aspx.cs" Inherits="Web_AdminGrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function fn_DeleteProject(str_Del_key) {
            if (confirm("Are you sure,you want to delete this?")) {
                $.ajax({
                    type: "POST",
                    url: "AdminGrid.aspx/Groupdelete",
         ...
         <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <div class="login-header">
             <h4>Admin Creation</h4>
                  <p>Here’s where you keep up with all your admin.</p>
            </div>
   ...
   <div class="col-6 d-flex justify-content-end">
       <div class="icons-list">
           <a href="AdminCreation.aspx" class="btn btn-primary waves-effect waves-light">  Create  <i class="fas fa-plus"></i> </a>
       </div>
   </div>
                    </div>
                </div>
    ...
    <table id="datatable-buttons" class="datatable table w-100 equal-width-table font-size-12 table-striped">
                       <thead>
                        ...
                        <tbody>
                            <asp:PlaceHolder ID="Admingrid" runat="server"></asp:PlaceHolder>
                        </tbody>
                    </table>
                </div>
            </div>
