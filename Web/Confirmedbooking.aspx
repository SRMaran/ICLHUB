<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Confirmedbooking.aspx.cs" Inherits="Web_Confirmedbooking" %>
    ...
    <script>
        function handleBookingAction(element, action) {
            const data = {
                ...
                bookid: element.getAttribute('data-bookid'),
              
            };
            $.ajax({
                type: "POST",
                url: "Confirmedbooking.aspx/InsertBooking",
                    ...
                    <div class="row mb-3">
                        <div class="col d-flex align-items-center">
                            <div class="login-header">
                                <h4>Your Bookings</h4>
                                <p>Here’s where you keep up with all your current bookings.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <br />
                                <%--<asp:Button ID="btnpinship" runat="server" CssClass="btn btn-outline-warning me-1 mb-1 custom-style" Text="Pinned Bookings" Style="font-size: 14px; margin-top: 5px;" OnClick="btnpinship_Click"></asp:Button>--%>
                                <asp:Button ID="btnpinship" runat="server" CssClass="btn btn-outline-warning me-1 mb-1 pinned-shipmnets-btn" Text="Pinned Bookings" Style="font-size: 14px; margin-top: 5px;" OnClick="btnpinship_Click"></asp:Button>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="DD_Status">Event Type :</label>
                                <%--<asp:DropDownList ID="DD_status" runat="server" CssClass="form-select p-1 custom-style" OnSelectedIndexChanged="DD_status_SelectedIndexChanged" AutoPostBack="true">--%>
                                <asp:DropDownList ID="DD_status" runat="server" CssClass="form-select p-1 event-types-btn" OnSelectedIndexChanged="DD_status_SelectedIndexChanged" AutoPostBack="true" >
...
<table id="BookingTables" class="datatable table  table-striped mb-0">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Booking ID</th>
...
<script>
    $(document).ready(function () {
        ...
        if (datefilter === "0") {
            ...
            initializeDataTablefilter(Transport, Startdate, Enddate, Roledatas, codedatas, Pin);
        }
    });
    ...
    function initializeDataTable(Transport, Roledatas, codedatas, Pin) {
     ...
     ajax: function (data, callback, settings) {
         ...
         $.ajax({
             type: "POST",
             url: "Confirmedbooking.aspx/GetShipmentDetails",
             contentType: "application/json; charset=utf-8",
             dataType: "json",
             data: JSON.stringify({
                 start: data.start,
     ...
     buttons: [
         ...
         },
         {
             ...
             columns: ":gt(0)",
             popoverTitle: "Customise your table columns <br> Please highlight fields in blue to view in the selection " + (document.title.split(" | ")[1] || "").trim() + " summary",
             exportOptions: { columns: ":visible:not(:first-child)" }
         }
     ],
     language: {
