<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Arriving.aspx.cs" Inherits="Web_Arriving" %>
...
border-radius: 7px;
    ...
    <script>   
        function handleShipmentAction(element, action) {
            ...
            $.ajax({
                type: "POST",
                url: "Arriving.aspx/InsertShipment",
                ...
                <div class="row mb-3">
                    <div class="col d-flex align-items-center">
                        <div class="login-header">
                            <h4>
                                <asp:Label ID="lb_shipment" runat="server" text="Arriving Today"></asp:Label>
                           ...
                           <%-- <p id="transitpara" runat="server">
                                Here's where you keep up with all your bookings in arriving today.
            ...
            function initializeDataTable(Transport, Roledatas, codedatas, Pin) {
                $("#shipmentTable").DataTable({
                    ...
                    ajax: function (data, callback, settings) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Arriving.aspx/GetShipmentDetails",
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            data: JSON.stringify({
                                start: data.start,
            ...
            function initializeDataTablefilter(Transport, Startdate, Enddate, Roledatas, codedatas) {
                $("#shipmentTable").DataTable({
                    ...
                    ajax: function (data, callback, settings) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Arriving.aspx/GetShipmentDetailsfilter",
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            data: JSON.stringify({
                                start: data.start,
                    ...
                    columns: [
                        {
                            ...
                            render: function (data, type, row) {
                                return `<i class="${row.icon}" 
    style="color: orange; cursor: pointer;"
    data-container="${row.spr_shipmentid}"
    onclick="handleShipmentAction(this, 'insert');">
</i>`;
                            }
                        },
