<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Originport.aspx.cs" Inherits="Web_Originport" %>
   ...
   <script>
    ...
    <script>   
        function handleShipmentAction(element, action) {
            ...
            $.ajax({
                type: "POST",
                url: "Originport.aspx/InsertShipment",
        ...
        <div class="buy-form-crypto mb-0">
                ...
                <div class="row mb-3">
                    <div class="col d-flex align-items-center">
                        <div class="login-header">
                            <h4>
                                <asp:Label ID="lb_shipment" runat="server" Text="Origin Shipments"></asp:Label>

                                <a id="evenbooking"
                                    runat="server"
                                    cssclass="btn btn-outline-primary"
                                    style="color: white; background-color: #112560; border-radius: 16px; padding: 5px 20px;"
                                    visible="false">Go to Bookings at Origin Port
                                </a>
                            </h4>
                            <%--<p id="transitpara" runat="server">
                                 Here's where you keep up with all your bookings in Origin Shipments.
            <asp:Label ID="lb_pragraph" runat="server"></asp:Label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="DD_Datefilter" runat="server" CssClass="form-select p-1 Datafilter" OnSelectedIndexChanged="DD_Datefilter_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-2">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group w-100">
                                                    <asp:TextBox type="date" runat="server" class="form-control p-2 custom-style" ID="fromDate" placeholder="mm/dd/yyyy" Style="width: 100%;" />
                                                </div>
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <div class="input-group w-100">
                                                    <asp:TextBox type="date" runat="server" class="form-control p-2 custom-style" ID="toDate" placeholder="mm/dd/yyyy" Style="width: 100%;" />
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="table-responsive">
                    <table id="shipmentTable" class="datatable table  table-striped mb-0">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Mode</th>
            ...
            function initializeDataTable(Transport, Roledatas, codedatas, Pin) {
                $("#shipmentTable").DataTable({
                    ...
                    ajax: function (data, callback, settings) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Originport.aspx/GetShipmentDetails",
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            data: JSON.stringify({
                                start: data.start,
            ...
            function initializeDataTablefilter(Transport, Startdate, Enddate, Roledatas, codedatas) {
                $("#shipmentTable").DataTable({
                    ...
                    ajax: function (data, callback, settings) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Originport.aspx/GetShipmentDetailsfilter",
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            data: JSON.stringify({
                                start: data.start,
