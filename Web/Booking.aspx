<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Booking.aspx.cs" Inherits="Web_Booking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        function handleBookingAction(element, action) {
            ...
            $.ajax({
                type: "POST",
                url: "Booking.aspx/InsertBooking",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        function initializeDataTablefilter(Transport, Startdate, Enddate, Roledatas, codedatas) {
            $('#BookingTables').DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Booking.aspx/GetShipmentDetailsfilter",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify({
                            start: data.start,
      ...
      onclick="handleBookingAction(this, 'insert');">
        ...
        <p id="close-popover" style="cursor:pointer; color:red; float:right; margin-top:-20px;">X</p>`,
                        exportOptions: { columns: ":visible:not(:first-child)" }
                    }
                ],
                language: {
        ...
        function initializeDataTable(Transport, Roledatas, codedatas, Pin) {
            $('#BookingTables').DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Booking.aspx/GetShipmentDetails",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify({
                            start: data.start,
