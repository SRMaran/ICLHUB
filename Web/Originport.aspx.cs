...
public partial class Web_Originport : System.Web.UI.Page
{
    DataAccess da;
    PhTemplate PH;
    Decrypt DE;
    ...
    private void shipmentdetails()
    {
        ...
        string str_shipmentgriddetails = "";
        string dateOnly = DateTime.UtcNow.Date.ToString("MM/dd/yyyy");
        lb_shipment.Text = "Origin Shipments";
        //lb_pragraph.Text = "Origin Shipments";
        switch (pin_data)
        {
            case "0":
                switch (userrole)
                {
                    case "0":
                        ...
                        {
                            case "0":
                                str_shipmentgriddetails = "EXEC GetorginshipmentAdmin";
                                break;
                            default:
                                str_shipmentgriddetails = "EXEC GetorginshipmentAdminevents @Startdate='" + Startdate + "' ,@Enddate= '" + Enddate + "' , @DD_status='" + ddl_evettype.SelectedValue + "'";
                    ...
                    case "2":
                        switch (str_Orgcode)
                        {
                            ...
                            default:
                                ...
                                {
                                    case "0":
                                        str_shipmentgriddetails = "EXEC Getorginshipmentclient @localclientcode='" + str_Orgcode + "'";
                                        break;
                                    default:
                                        str_shipmentgriddetails = "EXEC GetorginshipmentClientevents @localclientcode='" + str_Orgcode + "',@Startdate='" + Startdate + "' ,@Enddate= '" + Enddate + "' , @DD_status='" + ddl_evettype.SelectedValue + "'";
                ...
                break;
            case "1":
                str_shipmentgriddetails = "EXEC Getorginshipment_Pin @localclientcode = '" + str_Orgcode + "',@UserRole = '" + userrole + "'";
                break;
        ...
        {
            dt_shipment.Columns.Add("shipencryptid", typeof(string));
            dt_shipment.Columns.Add("icon", typeof(string));
            dt_shipment.Columns.Add("spr_tran", typeof(string));

            foreach (DataRow row in dt_shipment.Rows)
            {
                string shipmentid = row["spr_shipmentid"].ToString();
                string shipmentdecrpt = DE.Register(shipmentid);
                row["shipencryptid"] = shipmentdecrpt;
                //Icon//
            ...
            //this.PH.LoadGridItem(ds, PH_shipment, "Shipmentdetails.txt", "");
        }
    ...
    protected void DD_Datefilter_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        datefilters.Text = "1";
        ScriptManager.RegisterStartupScript(this, this.GetType(), "callAjax", "GetShipmentDetailsfilter('" + EventType + "," + userrole + "," + str_Org + "');", true);
    }
        ...
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection(da.ConnectionString.ToString()))
            {
                ...
                if (searchValue == "")
                {
                    ...
                    string countQuery = "EXEC GetorginshipmentCountdatefilter @Startdate='" + Startdate + "',@Enddate='" + Enddate + "',@controldata='" + controldata + "',@Clientcode='" + Clientcode + "',@DD_status='" + Transport + "'";
                    SqlCommand countCmd = new SqlCommand(countQuery, conn);
                    object countResult = countCmd.ExecuteScalar();
                    totalRecords = countResult != null ? Convert.ToInt32(countResult) : 0;
                    string query = "EXEC GetorginshipmentCountdate @Start='" + start + "', @Length='" + length + "',@Startdate='" + Startdate + "',@Enddate='" + Enddate + "',@Clientcode='" + Clientcode + "'," + ascanddesc + ",@DD_status='" + Transport + "'";
                ...
                {
                    // Get total record count
                    string countQuery = "EXEC GetorginshipmentCountdatesearch @DD_status='" + Transport + "',@Startdate='" + Startdate + "',@Enddate='" + Enddate + "',@Clientcode='" + Clientcode + "',@controldata='" + controldata + "',@search='" + searchValue + "'";
                    SqlCommand countCmd = new SqlCommand(countQuery, conn);
                    object countResult = countCmd.ExecuteScalar();
                    totalRecords = countResult != null ? Convert.ToInt32(countResult) : 0;
                    string query = "EXEC GetorginshipmentCountdatefiltersearch @Start='" + start + "', @Length='" + length + "',@DD_status='" + Transport + "',@Startdate='" + Startdate + "',@Enddate='" + Enddate + "',@Clientcode='" + Clientcode + "'," + ascanddesc + ",@search='" + searchValue + "'";
                    using (SqlCommand cmd = new SqlCommand(query, conn))
                    {
    ...
    public static string InsertShipment(string action, string shipmentid)
    {
        ...
        string shipmentcheckcheck = "select spr_shipmentid from ICL_PinnedOrigin where spr_shipmentid='" + shipmentid + "'";
        ...
        {
            action = "Inserted";
            query = "insert into ICL_PinnedOrigin(spr_shipmentid,ps_createdby,ClientCode)values(@spr_shipmentid,@ps_createdby,@ClientCode) ";
        }
        else
        {
            action = "Deleted";
            query = "DELETE FROM ICL_PinnedOrigin WHERE spr_shipmentid=@spr_shipmentid";
        }
        try
        {
    ...
    public static object GetShipmentDetails(int start, int length, int draw, string searchValue, string Transport, string Role, string Clientcode, string orderColumn, string orderDir, string Pin)
    {
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection(da.ConnectionString.ToString()))
            {
                ...
                {
                    // Get total record count
                    string countQuery = "EXEC GetorginshipmentCount @DD_status='" + Transport + "',@Clientcode='" + Clientcode + "',@controldata='" + controldata + "'";
                    SqlCommand countCmd = new SqlCommand(countQuery, conn);
                    object countResult = countCmd.ExecuteScalar();
                    totalRecords = countResult != null ? Convert.ToInt32(countResult) : 0;
                    string query = "EXEC GetorginshipmentData @Start='" + start + "', @Length='" + length + "',@DD_status='" + Transport + "',@Clientcode='" + Clientcode + "'," + ascanddesc + ",@Pin='" + Pin + "'";
                    using (SqlCommand cmd = new SqlCommand(query, conn))
                    {
                ...
                {
                    // Get total record count
                    string countQuery = "EXEC GetorginshipmentAdminSearch @search='" + searchValue + "',@Clientcode='" + Clientcode + "',@DD_status='" + Transport + "',@controldata='" + controldata + "'";
                    SqlCommand countCmd = new SqlCommand(countQuery, conn);
                    object countResult = countCmd.ExecuteScalar();
                    totalRecords = countResult != null ? Convert.ToInt32(countResult) : 0;
                    string query = "EXEC GetorginshipmentdataSearch @search='" + searchValue + "',@Start='" + start + "',@Length='" + length + "',@DD_status='" + Transport + "',@Clientcode='" + Clientcode + "',@controldata='" + controldata + "'";
                    using (SqlCommand cmd = new SqlCommand(query, conn))
                    {
