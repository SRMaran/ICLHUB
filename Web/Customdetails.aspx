<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Customdetails.aspx.cs" Inherits="Web_Customdetails" %>
...
.custom-message {
 ...
 <script>
     function submitSupportMessage() {
         ...
         $.ajax({
             type: "POST",
             url: "Customdetails.aspx/SupportMessage",
             data: JSON.stringify({
                 customId: customId,
                 message: message
             }),
    ...
    <script>
        function downloadFile1(customId, fileName) {
            if (!customId || !fileName) {
                alert("Invalid custom ID or file name.");
                return;
            }
            $.ajax({
                type: "POST",
                url: "Customdetails.aspx/DownloadDocument",
                data: JSON.stringify({ customId: customId, fileName: fileName }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
    ...
    <div class="row" style="overflow: hidden;">
        <div class="row">
            ...
            <div class="col-md-2 text-end">
                <a href="Custom.aspx" class="btn btn-primary btn-block account-btn"><i class="fas fa-undo"></i> Back</a>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="card-box">
        ...
        <div class="col-sm-6">
            <div class="card-box">
                ...
                <asp:PlaceHolder ID="PH_Custorder" runat="server"></asp:PlaceHolder>
            ...
            <div class="card-box">
                ...
                <asp:PlaceHolder ID="PH_Custdelivery" runat="server"></asp:PlaceHolder>
            </div>
            ...
            <div class="card-box">
                ...
                <asp:PlaceHolder ID="PH_Custshipdetails" runat="server"></asp:PlaceHolder>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card-box">
                ...
                <asp:PlaceHolder ID="PH_Custgooddetails" runat="server"></asp:PlaceHolder>
...
<div class="form-group">
 ...
 <asp:Label ID="lb_errorfile" runat="server" Visible="false"></asp:Label> 
    ...
    <asp:Button ID="Button1" runat="server" class="btn btn-primary submit-btn mt-2" Text="Upload" OnClick="btn_upload_Click"></asp:Button>
</div>
...
<div class="form-group">
            ...
            <div class="card-box">
                <div class="popup-content">
                    ...
                    <div class="fc-scroller fc-day-grid-container" style="overflow: hidden scroll; height: 300px; width: 600px">
                        <asp:PlaceHolder ID="PH_customdoc" runat="server"></asp:PlaceHolder>
                    </div>
                    <div class="form-group">
                        <div class="form-group text-lg-end">
  ...
  &times;
      ...
      <div class="modal-body text-center">
       ...
       <asp:Literal ID="customno" runat="server" Visible="false"></asp:Literal>
                                   <script>
    ...
    <script>
        function downloadFile(customId, fileName) {
            if (!customId || !fileName) {
            ...
            $.ajax({
                type: "POST",
                url: "Customdetails.aspx/UploadDownloadDocument",
                data: JSON.stringify({ customId: customId, fileName: fileName }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    if (response.d.startsWith("/Custom/")) {
