<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="Awaiting.aspx.cs" Inherits="Web_Awaiting" %>
...
border-radius: 7px;
    ...
    <script>   
        function handleShipmentAction(element, action) {
            ...
            $.ajax({
                type: "POST",
                url: "Awaiting.aspx/InsertShipment",
            ...
            function initializeDataTable(Transport, Roledatas, codedatas, Pin) {
                $("#shipmentTable").DataTable({
                    ...
                    ajax: function (data, callback, settings) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Awaiting.aspx/GetShipmentDetails",
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            data: JSON.stringify({
                                start: data.start,
            ...
            function initializeDataTablefilter(Transport, Startdate, Enddate, Roledatas, codedatas) {
                $("#shipmentTable").DataTable({
                    ...
                    ajax: function (data, callback, settings) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Awaiting.aspx/GetShipmentDetailsfilter",
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            data: JSON.stringify({
                                start: data.start,
