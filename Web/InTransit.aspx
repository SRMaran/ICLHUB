<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="InTransit.aspx.cs" Inherits="Web_InTransit" %>
 ...
 <script>
  ...
  <script>   
      function handleShipmentAction(element, action) {
          ...
          $.ajax({
              type: "POST",
              url: "InTransit.aspx/InsertShipment",
                ...
                <div class="row mb-3">
                    <div class="col d-flex align-items-center">
                        <div class="login-header">
                            <h4>
                                <asp:Label ID="lb_shipment" runat="server"  Text="Shipments in Transit"></asp:Label>

                                <a id="evenbooking"
                                    runat="server"
                                    cssclass="btn btn-outline-primary"
                                    style="color: white; background-color: #112560; border-radius: 16px; padding: 5px 20px;"
                                    visible="false">Go to Bookings in Transit
                                </a>
                            </h4>
                          <%--  <p id="transitpara" runat="server">
                                Here's where you keep up with all your bookings
                ...
                function initializeDataTable(Transport, Roledatas, codedatas, Pin) {
                    $("#shipmentTable").DataTable({
                        ...
                        ajax: function (data, callback, settings) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "InTransit.aspx/GetShipmentDetails",
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: JSON.stringify({
                                    start: data.start,
                ...
                function initializeDataTablefilter(Transport, Startdate, Enddate, Roledatas, codedatas) {
                    $("#shipmentTable").DataTable({
                        ...
                        ajax: function (data, callback, settings) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "InTransit.aspx/GetShipmentDetailsfilter",
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: JSON.stringify({
                                    start: data.start,
